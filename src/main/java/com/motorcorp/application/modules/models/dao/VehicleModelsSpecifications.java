...
public class VehicleModelsSpecifications<T extends AbstractTransactionalEntity> extends AbstractRepositorySpecification<T> {
    @Override
    protected Specification<T> query(String expression) {
        ...
        return (root, query, builder) -> builder.or(
                ...
                builder.like(root.get("variant"), contains(expression))
        );
    }
}
